...
- Tokenized Links: Currently, invite links are reusable. I would move to one-time tokenized invites for higher security.https://console.neon.tech/app/projects/steep-water-38840772 this is the link for neon db and the backend code to access this backend the api routes as you know will be inside the src folder with api folder and which has respectives route.ts files 